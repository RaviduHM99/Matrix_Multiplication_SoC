...
HD_PWD='C:/Projects/Matrix_SoC_v2/MVM/MVM.runs/design_1_matmul_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_matmul_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_matmul_wrapper_0_0.tcl
